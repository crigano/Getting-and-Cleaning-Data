...
To run the script, source `run_analysis.R`. You will see the following output as the script works:

```
[run_analysis.R] Getting and Cleaning Data Project 
[run_analysis.R] Reading in datasets. 
[run_analysis.R] Getting dataset: F:/Documents/Coursera/Getting and Cleaning Data/Getting-and-Cleaning-Data-Project-master/data/test 
[run_analysis.R]   reading features... 
[run_analysis.R]   reading activities... 
[run_analysis.R]   reading subjects... 
[run_analysis.R] Getting dataset: F:/Documents/Coursera/Getting and Cleaning Data/Getting-and-Cleaning-Data-Project-master/data/train 
[run_analysis.R]   reading features... 
[run_analysis.R]   reading activities... 
[run_analysis.R]   reading subjects... 
...
[run_analysis.R] Saving clean data to file: F:/Documents/Coursera/Getting and Cleaning Data/Getting-and-Cleaning-Data-Project-master/data/cleaned.txt 
```
